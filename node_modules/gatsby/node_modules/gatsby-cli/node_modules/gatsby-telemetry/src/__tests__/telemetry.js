...
describe(`Telemetry`, () => {
    ...
    describe(`trackFeatureIsUsed`, () => {
        it(`Attaches feature list to the events`, () => {
            ...
            telemetry.buildAndStoreEvent(`demo`, {});
            expect(EventStorage.mock.instances[0].addEvent).toHaveBeenCalledWith(expect.objectContaining({
                features: [`Foo:bar`],
            }));
        });
    });
    describe(`allows overriding defaults`, () => {
        it(`allows overriding componentId`, () => {
            ...
            expect(EventStorage.mock.instances[1].addEvent).toHaveBeenCalledWith(expect.objectContaining({
                componentId: `desktop`,
                gatsbyCliVersion: `1.2.3-beta1`,
            }));
        });

...
const content = {
  ...
  message1: {
    ...
    zh: "爸爸和妈妈是我对我最有启发的两个人。是他们教会我永远要有更高的目标。是他们守護我和我的兄弟姐妹不会挨饿受凍。他们总能在最恰当的时候给我们送来一盘水果或一碗炒饭。是他们熬夜帮我完成学校的项目或作业；在酒店房间床位不够的时候，是他们主动睡在房间的地板上。是他们在支持我所做的一切。其实我的家人并不常说“爱”这个词，但“爱”却几乎体现在了我父母做的所有事情上。爸爸妈妈，我也愛你們，就像爸爸爱喜力啤酒一样多。",
    es: "Maa y De.",
  ...
  message2: {
    ...
    zh: "这个网站不仅是献给我伟大的父母，也是献给所有寻求更好的机会而勇敢地抛开一切的移民。像我父母这样的移民，不应该被妖魔化为罪犯或不劳而获的人。他们是勤劳、有抱负、善良的人。是他们赋予了美国梦的真正意义。从逃离越南的共产主义和中国的专制政权开始，我父母来到美国的旅程并非没有艰辛和犹豫。我想记录他们的故事，纪念他们的牺牲。",
    es: "",

...
export const picturesMom = {
  ...
  tiananmenSquare: {
    caption: {
      en: "'Tank Man' taken at Tiananmen Square (1989)",
      zh: "天安门广场上的“坦克人” (1989)",
  ...
  vancouver: {
    caption: {
      en: "Vancouver, Canada (May 5th, 1993)",
      zh: "加拿大温哥华 (1993年5月5日)",
  ...
  momCool: {
    caption: {
      en: "Me outside Lantau Island, Hong Kong (1982)",
      zh: "我在香港大屿山外（1982)",
  ...
  momSunset: {
    caption: {
      en: "Me outside Lantau Island, Hong Kong (Nov 24 1984)",
      zh: "我在香港大屿山外（1984年11月24日)",
  ...
  momWork: {
    caption: {
      en: "Me at 'El Vette', where I worked (1987)",
      zh: "我在我工作过的“埃尔维特”（1987）",
  ...
  momSitting: {
    caption: {
      en: "Me during a business trip in Dongguan (1988)",
      zh: "我在东莞出差（1988)",
  ...
  familyToystore: {
    caption: {
      en: "My mom, husband, nephew-in-law, and me at KV Toy Store (Jan, 1996)",
      zh: "我的妈妈，丈夫，外，和我在KV玩具店 (1996年1月)",

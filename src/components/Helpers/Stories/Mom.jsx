...
const content = {
  ...
  p5: {
    ...
    zh: "也许最重要的是，移民到香港意味着从零开始。我们负担不起小弟弟的日托费用，所以我不得不在青少年时期用大部分的时间去照看他。典型的一天是从凌晨4:00 到我父母的食品摊上烹饪馒头开始的，然后去上学，晚上再回来帮父母干活。经济上的困难使我负担不起学年结束时的实地考察旅行。在解释缺席原因时，我常常会隐藏一种尴尬的感觉，告诉同学们那天我很忙。我的生活设施就是一个简单的房间，不比普通的卧室大，其中容纳了我和其他六个家庭成员。我最终从中学辍学了，转而与父母一起工作，后来又到一家工厂打工。我太穷了，没钱去上学，而且我也没有时间读书。手头特别紧，养育弟弟是我的责任。到如今我还是很伤心，因为有人告诉我，我穷得连学习的机会都没有。",
    es: "",
  ...
  p6: {
    ...
    zh: "在中国期间，我记得父亲对我和家人都和蔼可亲。 他会带我去七星岩，因为我喜欢看美丽的石灰岩峭壁。 然而在我们移居到香港后，一切都变了。 他变得越来越冷漠，与我和家人越来越疏远了。这种转变在他的日常行为中更加明显。尽管我们有足够的钱来购买普通食品，但我父亲还是会故意等到市场关门时用折扣价购买残羹剩饭。他会把节省下来的钱装进自己的口袋，再也不还给家人。我想就这些行为与他交流，但他好像根本不在乎我，只希望我离得远远的。被父母完全遗弃的感觉是如此令人沮丧，以至于我常常希望我们从未离开过共产主义的中国。",
    es: "",
  ...
  conclusion: {
    ...
    zh: "回想自己的成长历程，我不禁为自己不得不承受的挣扎和苦难而流泪。有一个几乎毫无爱心的父亲的经历，让我发誓绝不把那些不快乐的感觉传给我的孩子。我唯一的愿望就是让我的孩子过得比我好。我不想让别人来决定孩子们的未来。不管我曾经经历过什么，为了我出色的丈夫和漂亮的孩子们，我还会再做一次的。",
    es: "",

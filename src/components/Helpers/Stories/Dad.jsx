...
const content = {
  ...
  p1: {
    ...
    zh: "我出生在西贡的Chợ Lớn村，当时正值越南战争开始升级。在我童年的大部分时间中，生活都是相对普通的，但一切都在1968年发生了变化，那是我记忆中最糟糕的一年。越共和北越军在越南新年Tết那天攻打西贡。西贡的街道到处都受到了破坏，还有我同学的尸体。美国人朝平民村庄反击，胡乱轰炸。",
    es: "",
  ...
  p2: {
    ...
    zh: "直升机的呼啸声等同于撤离我村庄家园的信号。我的母亲、父亲、两个兄弟和四个姐妹会在附近的水井底找避难所。我每次都会想到死亡。直升机的声音渐渐远去，在我们出来时，只见房顶上有新的弹孔。随着呆在家里变得越来越危险，我和家人就会到附近的南越军基地寻求庇护，白天则是回到家里照料我们的菜地。",
    es: "",
  ...
  p4: {
    ...
    zh: "有一天晚上，我去市里吃河粉。在我的旁边有两个警察。当我从罗勒茎上摘下叶子放进汤里的时候，一个熟悉的没有左臂的男人走进了餐厅。那是我的邻居，他最近因企图逃避兵役而被抓。他被警察从家里带走，特意送到了前线作战师。在失去手臂后，他终于可以退伍了。他对自己的缺陷感到愤怒，拿出了一枚M69手榴弹，并把它扔向我的方向，靠近警察。我当时并没有面向他，当我听到手榴弹爆炸时，我都来不及反应。我的脸上和头上都是血。我马上跑到最近的出租车上，要去Chợ Rẫy医院。那里的一位医生说，如果我们不花钱献血者，那么我就会死。就在我生还的希望越来越小的时候，我哥哥的一个同学为我支付了手术费。直到今日，我和他还是好朋友。",
    es: "",
  ...
  p7: {
    en: "The end of the Vietnam War caused a mass exodus of people on water — these refugees were colloquially referred to as boat people. Between the years 1975 and 1995, over 800,000 refugees escaped Vietnam. Death estimates vary between 100,000 to 400,000 due to storms, diseases, starvation, and pirates. Boat captains would pay off the Vietnamese Navy patrol for safe passage to international waters. These boats weren't intended for deep, open waters, and success usually meant being saved by a passing freighter. If never rescued, refugees could be stranded at sea for weeks, having to endure the elements and pirates. It was a risky choice— flee communism for a better life or lose your life trying.",
    zh: "越战结束后，大规模的水上人口外流——这些难民被俗称为船民。1975年至1995年间，有超过80万难民逃离越南。由于风暴、疾病、饥饿和海盗等原因，死亡人数估计在10万到40万之间。船长们会花钱买通越南海军巡逻队，以获得前往国际水域的安全通道。这些船并不适合在深海、开阔的水域航行，而通常只有被路过的货船所救才可能成功抵达目的地。如果从未被救起，难民可能会在海上滞留数周，不得不忍受风雨和海盗的侵袭。这是一个冒险的选择——但为了逃离共产主义，获得更好得生活，这值得用生命去冒险。",
    es: "",
    vi: "Chiến tranh Việt Nam kết thúc đã tạo ra một làn sóng di cư ồ ạt bằng đường thủy— những người tị nạn này thường được gọi chung là thuyền nhân. Từ năm 1975 đến 1995, hơn 800.000 người tị nạn đã trốn khỏi Việt Nam. Ước tính số người chết dao động từ 100.000 đến 400.000 người do bão, bệnh tật, chết đói và cướp biển. Thuyền trưởng sẽ trả tiền cho lực lượng tuần tra Hải quân Việt Nam để đổi lấy đường đi an toàn đến hải phận quốc tế. Những chiếc thuyền này thường không được thiết kế dành cho những vùng nước biển sâu và rộng. Đối với chúng, thành công nghĩa là được cứu bởi một tàu chở hàng đi ngang qua. Nếu không được cứu, những người tị nạn có thể bị mắc kẹt trên biển trong nhiều tuần, phải chịu đựng mưa bão và cướp biển. Đó là một lựa chọn mạo hiểm - chạy trốn khỏi chủ nghĩa cộng sản để sống một cuộc đời tốt hơn hoặc cố gắng cho đến chết.", 
  },
  p8: {
  ...
  p13: {
    ...
    zh: "一提到9月11日，很容易想到的是曼哈顿世贸中心的袭击。我记住这个日子的原因却不同。1991年9月11日，我正在去机场接弟弟的路上。之前我问弟弟是否可以回到费城来给我的新餐馆帮忙。当我到达机场的时候，我接到了其中一个妹妹的电话。我听到她边哭边说：“飞机坠毁了。” 我调转车头，去我妈家里，把这个消息告诉她。我妈的心彻底碎了。她哭了好几个月。这大概是我一生中最难过的时刻，我知道如果我不叫他来帮我，他就不会遇难。我意识到自己不想再做餐馆生意后，就把餐馆卖了。",
    es: "",
  ...
  conclusion: {
    ...
    zh: "我觉得自己在很多方面都很幸运。如果不是叔叔的同学，我早就因为被手榴弹炸伤而死了。要不是哥哥的同学，我早就被手榴弹炸伤而死了。在我的一生中，我见过许多可怕的事情，但我也看到了人们心中的善良。我尽量对人友好，富有同情心，因为是别人的友好和同情心让我得以生活。我希望我的孩子能成为一个好人，永远不要限制自己。尽管经历了那么多磨难，但只要能看到我美丽的妻子和三个孩子，我愿意重来一次。",
    es: "",
